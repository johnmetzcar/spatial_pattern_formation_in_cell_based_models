...
class UserTab(object):
    ...
    def __init__(self):
        ...
        param_name17 = Button(description='b_cell_persistence_time', disabled=True, layout=name_button_layout)
        ...
        param_name18 = Button(description='b_cell_migration_speed', disabled=True, layout=name_button_layout)
        ...
        param_name19 = Button(description='b_cell_migration_bias', disabled=True, layout=name_button_layout)
        ...
        param_name20 = Button(description='b_cell_divide_time', disabled=True, layout=name_button_layout)
        ...
        param_name21 = Button(description='b_cell_apoptosis_rate', disabled=True, layout=name_button_layout)
        ...
        param_name22 = Button(description='b_cell_alpha_uptake_rate', disabled=True, layout=name_button_layout)
        ...
        param_name23 = Button(description='b_cell_alpha_secretion_rate', disabled=True, layout=name_button_layout)
        ...
        param_name24 = Button(description='b_cell_alpha_saturation_density', disabled=True, layout=name_button_layout)
        ...
        param_name25 = Button(description='b_cell_beta_uptake_rate', disabled=True, layout=name_button_layout)
        ...
        param_name26 = Button(description='b_cell_beta_secretion_rate', disabled=True, layout=name_button_layout)
        ...
        param_name27 = Button(description='b_cell_beta_saturation_density', disabled=True, layout=name_button_layout)
        ...
        param_name28 = Button(description='model_number', disabled=True, layout=name_button_layout)
        ...
        param_name29 = Button(description='placement_pattern', disabled=True, layout=name_button_layout)
        ...
        param_name30 = Button(description='cell_frac_A', disabled=True, layout=name_button_layout)
        ...
        desc_button10 = Button(description='A-type cell base apoptosis rate', disabled=True, layout=desc_button_layout) 
        desc_button10.style.button_color = 'tan'
        desc_button11 = Button(description='A-type cell alpha uptake rate', disabled=True, layout=desc_button_layout) 
        desc_button11.style.button_color = 'lightgreen'
        desc_button12 = Button(description='A-type cell alpha secretion rate', disabled=True, layout=desc_button_layout) 
        desc_button12.style.button_color = 'tan'
        desc_button13 = Button(description='A-type cell alpha saturation density', disabled=True, layout=desc_button_layout) 
        desc_button13.style.button_color = 'lightgreen'
        desc_button14 = Button(description='A-type cell beta uptake rate', disabled=True, layout=desc_button_layout) 
        desc_button14.style.button_color = 'tan'
        desc_button15 = Button(description='A-type cell beta secretion rate', disabled=True, layout=desc_button_layout) 
        desc_button15.style.button_color = 'lightgreen'
        desc_button16 = Button(description='A-type cell beta saturation density', disabled=True, layout=desc_button_layout) 
        ...
        desc_button18 = Button(description='B-type cell base speed', disabled=True, layout=desc_button_layout) 
        desc_button18.style.button_color = 'tan'
        desc_button19 = Button(description='B-type cell motility bias', disabled=True, layout=desc_button_layout) 
        desc_button19.style.button_color = 'lightgreen'
        desc_button20 = Button(description='B-type cell base proliferation time', disabled=True, layout=desc_button_layout) 
        desc_button20.style.button_color = 'tan'
        desc_button21 = Button(description='B-type cell base apoptosis rate', disabled=True, layout=desc_button_layout) 
        desc_button21.style.button_color = 'lightgreen'
        desc_button22 = Button(description='B-type cell alpha uptake rate', disabled=True, layout=desc_button_layout) 
        desc_button22.style.button_color = 'tan'
        desc_button23 = Button(description='B-type cell alpha secretion rate', disabled=True, layout=desc_button_layout) 
        desc_button23.style.button_color = 'lightgreen'
        desc_button24 = Button(description='B-type cell alpha saturation density', disabled=True, layout=desc_button_layout) 
        desc_button24.style.button_color = 'tan'
        desc_button25 = Button(description='B-type cell beta uptake rate', disabled=True, layout=desc_button_layout) 
        desc_button25.style.button_color = 'lightgreen'
        desc_button26 = Button(description='B-type cell beta secretion rate', disabled=True, layout=desc_button_layout) 
        desc_button26.style.button_color = 'tan'
        desc_button27 = Button(description='B-type cell beta secretion rate', disabled=True, layout=desc_button_layout) 
        desc_button27.style.button_color = 'lightgreen'
        desc_button28 = Button(description='Select which model to use: 1,2,3', disabled=True, layout=desc_button_layout) 
        desc_button28.style.button_color = 'tan'
        desc_button29 = Button(description='Option to change placement: -1 for stripes, -2 for stripes with spaces and >= 0 for full domain with higher number being more sparce', disabled=True, layout=desc_button_layout) 
        desc_button29.style.button_color = 'lightgreen'
        desc_button30 = Button(description='Average percent A-type cells at simulation initialization', disabled=True, layout=desc_button_layout) 
        ...
        row17 = [param_name17, self.b_cell_persistence_time, units_button17, desc_button17] 
        row18 = [param_name18, self.b_cell_migration_speed, units_button18, desc_button18] 
        row19 = [param_name19, self.b_cell_migration_bias, units_button19, desc_button19] 
        row20 = [param_name20, self.b_cell_divide_time, units_button20, desc_button20] 
        row21 = [param_name21, self.b_cell_apoptosis_rate, units_button21, desc_button21] 
        row22 = [param_name22, self.b_cell_alpha_uptake_rate, units_button22, desc_button22] 
        row23 = [param_name23, self.b_cell_alpha_secretion_rate, units_button23, desc_button23] 
        row24 = [param_name24, self.b_cell_alpha_saturation_density, units_button24, desc_button24] 
        row25 = [param_name25, self.b_cell_beta_uptake_rate, units_button25, desc_button25] 
        row26 = [param_name26, self.b_cell_beta_secretion_rate, units_button26, desc_button26] 
        row27 = [param_name27, self.b_cell_beta_saturation_density, units_button27, desc_button27] 
        row28 = [param_name28, self.model_number, units_button28, desc_button28] 
        row29 = [param_name29, self.placement_pattern, units_button29, desc_button29] 
        row30 = [param_name30, self.cell_frac_A, units_button30, desc_button30] 
